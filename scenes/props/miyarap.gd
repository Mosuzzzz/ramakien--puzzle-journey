...
const QUESTIONS := [
	...
	["ข้อใดเขียนสะกดคำได้ถูกต้องที่สุด?", ["สังเกต", "สังเกตุ", "สังเกตุ์"], 0],
	["คำใดอยู่ในมาตราตัวสะกดแม่กม?", ["ร่ม", "ลม", "ถูกทุกข้อ"], 2],
	["คำว่า “สวยงาม” เป็นคำประเภทใด?", ["คำซ้อน", "คำซ้ำ", "คำสมาส"], 0],
	["ข้อใดเป็นคำราชาศัพท์ของคำว่า “นอน”?", ["บรรทม", "เสวย", "ตรัส"], 0],
	["คำใดเป็นคำพ้องเสียงกับคำว่า “จันทร์”?", ["จันทร์ – จันทน์", "บ้าน – เรือน", "สูง – ต่ำ"], 0],
	["“อิเหนา” เป็นวรรณคดีประเภทใด?", ["นิทาน", "บทละคร", "นิราศ"], 1],
	["คำว่า “กตัญญู” หมายความว่าอย่างไร?", ["การรู้คุณและตอบแทน", "การมีความรู้สูง", "การมีกำลังมาก"], 0],
	["คำใดเป็นคำซ้อน?", ["บ้านเรือน", "เด็กเด็ก", "สวยงามตระการตา"], 0],
	["คำใดอยู่ในมาตราตัวสะกดแม่เกอว?", ["ดาว", "แมว", "ถูกทุกข้อ"], 2],
	["คำใดเป็นคำประวิศันชนีย์?", ["มะลิ", "ขนม", "ตลาด"], 0],
	["ข้อใดมีการเขียนสะกดคำผิด?", ["เกรงใจ", "กะเพรา", "รสชาติ์"], 2],
	["คำว่า “กรรมาธิการ” อ่านว่าอย่างไร?", ["กำ-มา-ทิ-กาน", "กะ-ระ-มา-ทิ-กาน", "กำ-มะ-ทิ-กาน"], 0],
]
