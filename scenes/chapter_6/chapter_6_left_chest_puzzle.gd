...
const QUESTIONS := [
	{
		"question": "คำราชาศัพท์ของคำว่า “รองเท้า” คือข้อใด?",
		"choices": ["ฉลองพระบาท", "พระสุวรรณภูมิ", "ซับพระพักตร์"],
		"correct_index": 0,
	},
	{
		"question": "“พระฉาย” หมายถึงสิ่งใด?",
		"choices": ["กระจกเงา", "หวี", "น้ำหอม"],
		"correct_index": 0,
	},
	{
		"question": "คำราชาศัพท์ของคำว่า “แว่นตา” คือข้อใด?",
		"choices": ["ฉลองพระเนตร", "พระวิสูตร", "พระเขนย"],
		"correct_index": 0,
	},
]
