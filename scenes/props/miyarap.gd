...
const QUESTIONS := [
	["คำราชาศัพท์ของคำว่า “กิน” คือข้อใด?", ["เสวย", "บรรทม", "ประทับ"], 0],
	["คำราชาศัพท์ของคำว่า “นอน” คือข้อใด?", ["บรรทม", "ประชวร", "สรงน้ำ"], 0],
	["ข้อใดคือคำราชาศัพท์ของคำว่า “ป่วย”?", ["ประชวร", "พระราชสาส์น", "พระเศียร"], 0],
	["“พระเนตร” หมายถึงอวัยวะใด?", ["ดวงตา", "จมูก", "ปาก"], 0],
	["คำราชาศัพท์ของคำว่า “ร้องไห้” คือข้อใด?", ["ทรงพระกันแสง", "ทรงพระสรวล", "ทรงพระอักษร"], 0],
	["“พระกรรณ” หมายถึงอวัยวะใด?", ["หู", "คอ", "มือ"], 0],
	["คำราชาศัพท์ของคำว่า “โกรธ” คือข้อใด?", ["กริ้ว", "โปรด", "ตรัส"], 0],
	["“พระหัตถ์” หมายถึงสิ่งใด?", ["มือ", "เท้า", "หัวใจ"], 0],
	["ข้อใดคือคำราชาศัพท์ที่หมายถึง “หัวเราะ”?", ["ทรงพระสรวล", "ทรงพระดำเนิน", "ทรงม้า"], 0],
	["คำว่า “ตรัส” มีความหมายตรงกับข้อใด?", ["พูด", "ฟัง", "ดู"], 0],
	["ข้อใดคือคำราชาศัพท์ของคำว่า “อาบน้ำ”?", ["สรงน้ำ", "เสวยน้ำ", "ชำระพระวรกาย"], 0],
	["“พระบาท” หมายถึงอวัยวะใด?", ["เท้า", "ขา", "แขน"], 0],
	["คำราชาศัพท์ของคำว่า “เดิน” คือข้อใด?", ["ทรงพระดำเนิน", "ประทับ", "เสด็จประพาส"], 0],
]
